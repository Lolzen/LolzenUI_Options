...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["unitframes"] == true then
		...
		local title = ns.createTitle("uf_targettarget_options", "Unitframes module: Targettarget Options")

		local width_text = ns.createFontstring("uf_targettarget_options", "Width:")
		...
		local height_text = ns.createFontstring("uf_targettarget_options", "Height:")
		...
		local header1 = ns.createHeader("uf_targettarget_options", "Healthpoints")
		header1:SetPoint("TOPLEFT", width_text, 0, -30)

		local cb1 = ns.createCheckBox("uf_targettarget_options", "uf_targettarget_use_custom_font_hp", "|cff5599ffoverwrite the general font options for targettarget healthpoints|r", LolzenUIcfg.unitframes["uf_targettarget_use_own_hp_font_settings"])
		cb1:SetPoint("TOPLEFT", header1, "BOTTOMLEFT", 0, -8)

		local hp_pos_x_text = ns.createFontstring("uf_targettarget_options", "PosX:")
		...
		local hp_pos_y_text = ns.createFontstring("uf_targettarget_options", "PosY:")
		...
		local hp_anchor_text = ns.createFontstring("uf_targettarget_options", "Anchor:")
		...
		local hp_font_text = ns.createFontstring("uf_targettarget_options", "Font:")
		...
		local hp_font_size_text = ns.createFontstring("uf_targettarget_options", "Font size:")
		...
		local hp_font_flag_text = ns.createFontstring("uf_targettarget_options", "Font flag:")
