...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["clock"] == true then
		...
		local font_text = ns.createFontstring("clock", "Font:")
		...
		local font_size_text = ns.createFontstring("clock", "Size:")
		...
		local font_flag_text = ns.createFontstring("clock", "Flag:")
		...
		local color_text = ns.createFontstring("clock", "Color:")
		...
		local seconds_font_text = ns.createFontstring("clock", "Font:")
		...
		local seconds_font_size_text = ns.createFontstring("clock", "Size:")
		...
		local seconds_font_flag_text = ns.createFontstring("clock", "Flag:")
		...
		local seconds_color_text = ns.createFontstring("clock", "Color:")
		...
		local pos_x_text = ns.createFontstring("clock", "PosX:")
		...
		local pos_y_text = ns.createFontstring("clock", "PosY:")
		...
		local anchor_text = ns.createFontstring("clock", "Anchor1:")
		...
		local anchor_text2 = ns.createFontstring("clock", "Anchor2:")
		...
		LolzenUI_Options.UpdateOptionPanel_clock = function(self)
			...
			UIDropDownMenu_SetSelectedName(font_flag, LolzenUIcfg.clock["clock_font_flag"])
			UIDropDownMenu_SetText(font_flag, LolzenUIcfg.clock["clock_font_flag"])
			UIDropDownMenu_SetSelectedName(seconds_font_flag, LolzenUIcfg.clock["clock_seconds_font_flag"])
			UIDropDownMenu_SetText(seconds_font_flag, LolzenUIcfg.clock["clock_seconds_font_flag"])
			UIDropDownMenu_SetSelectedName(anchor, LolzenUIcfg.clock["clock_anchor1"])
			UIDropDownMenu_SetText(anchor, LolzenUIcfg.clock["clock_anchor1"])
			UIDropDownMenu_SetSelectedName(anchor2, LolzenUIcfg.clock["clock_anchor2"])
