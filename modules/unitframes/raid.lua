...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["unitframes"] == true then
		...
		local cb1 = ns.createCheckBox("uf_raid_options", "uf_raid_enabled", "|cff5599ff"..L["sub_panel_unitframes_raid_use_LolzenUI"].."", LolzenUIcfg.unitframes["uf_raid_enabled"])
		...
		local cb2 = ns.createCheckBox("uf_raid_options", "uf_raid_use_custom_font_hp", "|cff5599ff"..L["uf_healthpoints_overwrite_global_settings"].."|r", LolzenUIcfg.unitframes["uf_raid_use_own_hp_font_settings"])
		...
		local cb3 = ns.createCheckBox("uf_raid_options", "uf_raid_ri", "|cff5599ff"..L["uf_show_roleindicator"].."|r", LolzenUIcfg.unitframes["uf_raid_showroleindicator"])
