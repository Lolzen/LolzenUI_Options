...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["chat"] == true then
		...
		local cb2 = ns.createCheckBox("chat", "chat_brackets", "|cff5599ffstrip brackets from links (items, achievements, etc)|r", LolzenUIcfg.chat["chat_strip_brackets"], "content")
		cb2:SetPoint("TOPLEFT", cb1, "BOTTOMLEFT", 0, 0)

		local cb3 = ns.createCheckBox("chat", "chat_timestamp", "|cff5599ffshow timestamps|r", LolzenUIcfg.chat["chat_timestamp"], "content")
		cb3:SetPoint("TOPLEFT", cb2, "BOTTOMLEFT", 0, 0)

		local cb4 = ns.createCheckBox("chat", "chat_fading", "|cff5599ffdisable fading|r", LolzenUIcfg.chat["chat_disable_fading"], "content")
		cb4:SetPoint("TOPLEFT", cb3, "BOTTOMLEFT", 0, 0)

		local cb5 = ns.createCheckBox("chat", "chat_auto_who", "|cff5599ffauto /who for new whispers|r", LolzenUIcfg.chat["chat_auto_who"], "content")
		cb5:SetPoint("TOPLEFT", cb4, "BOTTOMLEFT", 0, 0)

		local cb6 = ns.createCheckBox("chat", "chat_afkdnd_once", "|cff5599ffshow afk/dnd messages only once per person|r", LolzenUIcfg.chat["chat_show_afkdnd_once"], "content")
		...
		local pos_y_text = ns.createFontstring("chat", "PosY:", "content")
		...
		local anchor_text = ns.createFontstring("chat", "Anchor1:", "content")
		...
		local anchor2_text = ns.createFontstring("chat", "Anchor2:", "content")
		...
		local font_size_text = ns.createFontstring("chat", "Size:", "content")
		...
		local font_flag_text = ns.createFontstring("chat", "Flag:", "content")
		...
		local spacing_text = ns.createFontstring("chat", "Spacing:", "content")
		...
		local alpha_text = ns.createFontstring("chat", "Alpha:", "content")
		...
		local border_text = ns.createFontstring("chat", "Border:", "content")
		...
		local header4 = ns.createHeader("chat", "Flags & Sticky Channels: (0 = false, 1 = true)", "content")
		header4:SetPoint("TOPLEFT", texture_text, "BOTTOMLEFT", 0, -30)

		local sticky_say_text = ns.createFontstring("chat", "Say:", "content")
		...
		local sticky_yell_text = ns.createFontstring("chat", "Yell:", "content")
		...
		local sticky_party_text = ns.createFontstring("chat", "Party:", "content")
		...
		local sticky_guild_text = ns.createFontstring("chat", "Guild:", "content")
		...
		local sticky_officer_text = ns.createFontstring("chat", "Officer:", "content")
		...
		local sticky_raid_text = ns.createFontstring("chat", "Raid:", "content")
		...
		local sticky_raidwarning_text = ns.createFontstring("chat", "Raid Warning:", "content")
		...
		local sticky_whisper_text = ns.createFontstring("chat", "Whisper:", "content")
		...
		local sticky_channel_text = ns.createFontstring("chat", "Channel:", "content")
		...
		local chat_afkflag_text = ns.createFontstring("chat", "AFK flag:", "content")
		...
		local chat_dndflag_text = ns.createFontstring("chat", "DND flag:", "content")
