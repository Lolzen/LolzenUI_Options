...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["nameplates"] == true then
		...
		local height_text = ns.createFontstring("nameplates", "Height:")
		...
		local width_text = ns.createFontstring("nameplates", "Width:")
		...
		local texture_text = ns.createFontstring("nameplates", "Texture:")
		...
		local selected_text = ns.createFontstring("nameplates", "Target nameplate scale:")
		...
		local lvlname_font_text = ns.createFontstring("nameplates", "Font:")
		...
		local lvlname_font_size_text = ns.createFontstring("nameplates", "Size:")
		...
		local lvlname_font_flag_text = ns.createFontstring("nameplates", "Flag:")
		...
		local lvlname_pos_x_text = ns.createFontstring("nameplates", "PosX:")
		...
		local lvlname_pos_y_text = ns.createFontstring("nameplates", "PosY:")
		...
		local lvlname_anchor_text = ns.createFontstring("nameplates", "Anchor1:")
		...
		local rt_size_text = ns.createFontstring("nameplates", "Size:")
		...
		local rt_pos_x_text = ns.createFontstring("nameplates", "PosX:")
		...
		local rt_pos_y_text = ns.createFontstring("nameplates", "PosY:")
		...
		local rt_anchor_text = ns.createFontstring("nameplates", "Anchor:")
