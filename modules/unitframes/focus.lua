...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["unitframes"] == true then
		...
		local scrollFrame = ns.createScrollFrame("uf_focus_options", 204)

		local width_text = ns.createFontstring("uf_focus_options", L["width"]..":", "content")
		width_text:SetPoint("TOPLEFT", ns.uf_focus_options.content, 20, -20)

		local wtBG = ns.createBackground("uf_focus_options", 580, 34, "content")
		...
		local header1BG = ns.createBackground("uf_focus_options", 580, 86, "content")
		...
		local header2BG = ns.createBackground("uf_focus_options", 580, 86, "content")
		...
		local header3BG = ns.createBackground("uf_focus_options", 580, 133, "content")
		...
		aura_spacing:SetScript("OnEnterPressed", function(self)
			...
			self.oldText = self:GetText()
			LolzenUI.SetUFFocusAuraSpacing()
		end)
		...
		cb3:SetScript("OnClick", function(self)
			...
			LolzenUI.SetUFFocusAuraDesatureNonPlayerAuras()
		end)

		local header4 = ns.createHeader("uf_focus_options", L["uf_castbar"], "content")

		local header4BG = ns.createBackground("uf_focus_options", 580, 38, "content")
		...
		cb2:SetScript("OnClick", function(self)
			...
			LolzenUI.SetUFFocusAuraShowOnlyPlayerAuras()
		...
		local header5BG = ns.createBackground("uf_focus_options", 580, 58, "content")
		...
		cb_icon_size:SetScript("OnEnterPressed", function(self)
			...
			self.oldText = self:GetText()
			LolzenUI.SetUFFocusCBIconCutAndSize()
		end)
		...
		local header6BG = ns.createBackground("uf_focus_options", 580, 38, "content")
		...
		local header7BG = ns.createBackground("uf_focus_options", 580, 38, "content")
		...
		local header8BG = ns.createBackground("uf_focus_options", 580, 38, "content")
		...
		cb_font_color.setActualColors = function()
			...
			LolzenUI.SetUFFocusCBTextColor()
		end
