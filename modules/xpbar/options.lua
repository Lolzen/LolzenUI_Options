...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["xpbar"] == true then
		...
		local height_text = ns.createFontstring("xpbar", "Height:")
		...
		local width_text = ns.createFontstring("xpbar", "Width:")
		...
		local alpha_text = ns.createFontstring("xpbar", "Alpha:")
		...
		local bg_alpha_text = ns.createFontstring("xpbar", "Background alpha:")
		...
		local pos_x_text = ns.createFontstring("xpbar", "PosX:")
		...
		local pos_y_text = ns.createFontstring("xpbar", "PosY:")
		...
		local anchor_text = ns.createFontstring("xpbar", "Anchor:")
		...
		local parent_text = ns.createFontstring("xpbar", "Parent:")
		...
		local texture_text = ns.createFontstring("xpbar", "Texture:")
		...
		local color_text = ns.createFontstring("xpbar", "Regular xpbar color:")
		...
		local color_text2 = ns.createFontstring("xpbar", "Rested xpbar color:")
		...
		local color_text3 = ns.createFontstring("xpbar", "PvP color (prestige):")
		...
		local color_text4 = ns.createFontstring("xpbar", "Paragon xp color:")
		...
		local font_text = ns.createFontstring("xpbar", "Font:")
		...
		local font_size_text = ns.createFontstring("xpbar", "Font size:")
		...
		local font_flag_text = ns.createFontstring("xpbar", "Font flag:")
		...
		local font_color_text = ns.createFontstring("xpbar", "Font color:")
		...
		local text_pos_x_text = ns.createFontstring("xpbar", "Text PosX:")
		...
		local text_pos_y_text = ns.createFontstring("xpbar", "Text PosY:")
		...
		local text_anchor_text = ns.createFontstring("xpbar", "Text Anchor:")
		...
		LolzenUI_Options.UpdateOptionPanel_xpbar = function(self)
			...
			UIDropDownMenu_SetText(anchor, LolzenUIcfg.xpbar["xpbar_anchor"])
			...
			UIDropDownMenu_SetText(texture, LolzenUIcfg.xpbar["xpbar_texture"])
			UIDropDownMenu_SetSelectedName(alpha, LolzenUIcfg.xpbar["xpbar_alpha"])
			UIDropDownMenu_SetText(alpha, LolzenUIcfg.xpbar["xpbar_alpha"])
			UIDropDownMenu_SetSelectedName(bg_alpha, LolzenUIcfg.xpbar["xpbar_bg_alpha"])
			UIDropDownMenu_SetText(bg_alpha, LolzenUIcfg.xpbar["xpbar_bg_alpha"])
			...
			UIDropDownMenu_SetText(font, LolzenUIcfg.xpbar["xpbar_font"])
			...
			UIDropDownMenu_SetText(font_flag, LolzenUIcfg.xpbar["xpbar_font_flag"])
			...
			UIDropDownMenu_SetText(text_anchor, LolzenUIcfg.xpbar["xpbar_text_anchor1"])
		end
