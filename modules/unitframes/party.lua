...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["unitframes"] == true then
		...
		local cb1 = ns.createCheckBox("uf_party_options", "uf_party_enabled", "|cff5599ff"..L["sub_panel_unitframes_party_use_LolzenUI"].."|r", LolzenUIcfg.unitframes["uf_party_enabled"])
		cb1:SetPoint("TOPLEFT", title, "BOTTOMLEFT", 0, -30)

		local cb2 = ns.createCheckBox("uf_party_options", "uf_party_vertical", "|cff5599ff"..L["sub_panel_unitframes_party_use_vertical_layout"].."|r", LolzenUIcfg.unitframes["uf_party_use_vertical_layout"])
		...
		local cb3 = ns.createCheckBox("uf_party_options", "uf_party_use_custom_font_hp", "|cff5599ff"..L["uf_healthpoints_overwrite_global_settings"].."|r", LolzenUIcfg.unitframes["uf_party_use_own_hp_font_settings"])
		...
		local cb4 = ns.createCheckBox("uf_party_options", "uf_party_ri", "|cff5599ff"..L["uf_show_roleindicator"].."|r", LolzenUIcfg.unitframes["uf_party_showroleindicator"])
