...
f:SetScript("OnEvent", function(self, event, addon)
	if addon == "LolzenUI_Options" and LolzenUIcfg.modules["slashcommands"] == true then
		...
		local desc1 = ns.createFontstring("slashcommands", "a short version of /reload")
		...
		local desc2 = ns.createFontstring("slashcommands", "prints the framename the mouse is hovering above")
		...
		local desc3 = ns.createFontstring("slashcommands", "prints the frames's childnames the mouse is hovering above")
		...
		local desc4 = ns.createFontstring("slashcommands", "opens up the helpeframe (for submitting tickets etc)")
		...
		local desc5 = ns.createFontstring("slashcommands", "opens the optionpanel of LolzenUI")
